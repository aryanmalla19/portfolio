    ...
    <div id='about' className='my-20 flex lg:flex-row flex-col'>
      ...
      <div className='lg:w-6/12 w-full pt-9 lg:pt-0 border-t-2 lg:border-t-0 lg:border-l-2 border-current pb-5'>
        <div className='lg:w-10/12 w-11/12 mx-auto'>
          ...
          <p className='text-base text-justify text-main'>Hey👋, I'm Aryan Malla Thakuri! I'm a self-taught developer & designer from Kathmandu, Nepal, who is really into unique designs, user experience and writing clean code.
<br /> <br /> 
