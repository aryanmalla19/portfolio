...
export default function Client() {
  ...
  return (
    <div id='project' className='md:pt-24 sticky md:flex-col justify-center items-center top-0 lg:flex-none lg:justify-none lg:items-none'>
      <h1 className='text-3xl md:mt-2 text-center md:text-left md:text-4xl lg:text-6xl dark:text-white tracking-wide font-bold leading-tight dark:text-orange text-main'>My Projects</h1>
      ...
      <img src={`${dark?`${cartoon}`:"https://varunbhabhra.com/static/media/portfolioDoodle.bc1fc5721437180c4b90a9b4274c9b11.svg"}`} className={`mx-auto md:h-[200px] h-[150px] md:ml-10 ${dark?"":"transform -scale-x-100"}`} alt="idk" />
      ...
      <ul className='flex w-full justify-center lg:justify-start items-center flex-wrap list-disc'>
        ...
        <li className='text-main dark:text-white text-base md:text-md mx-4 my-1 md:mx-6 font-bold'>HTML</li>
        <li className='text-main dark:text-white text-base md:text-md mx-4 my-1 md:mx-6 font-bold'>CSS</li>
