...
export default function Client() {
  return (
    <div id='project' className='md:pt-24 sticky md:flex-col justify-center items-center top-0 lg:flex-none lg:justify-none lg:items-none'>
      ...
      <img src='https://varunbhabhra.com/static/media/portfolioDoodle.bc1fc5721437180c4b90a9b4274c9b11.svg' className='lg:h-[300px] mx-auto md:h-[260px] h-[150px] md:ml-10 transform -scale-x-100' alt="idk" />
