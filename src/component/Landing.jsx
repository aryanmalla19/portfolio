  ...
  return (
    <div id="home" className='flex flex-col-reverse md:flex md:flex-row mb-20 justify_between'>
      <div className='flex w-full md:w-8/12 flex-col'>
        <img src={m} className='w-[200px] opacity-25 hidden md:block md:w-[350px] lg:w-[420px] my-3 md:mt-6' alt="img" />
        ...
        <h1 className={`text-center md:text-left text-2xl md:text-4xl lg:text-5xl font-bold loose text-main font-poppins`}>Empowering brands with custom, high-converting websites</h1>
        ...
        <div className='flex flex-col md:items-start lg:flex-row w-full items-center '>
          ...
          <PopupButton className="transition-transform duration-300 transform hover:scale-105 lg:mr-3 mt-3 lg:mt-5 flex justify-center items-center lg:justify-start px-10 py-3 w-[300px] lg:w-[340px] font-bold text-base lg:text-xl border-2 border-solid rounded-lg bg-orange border-orange text-white"
