  ...
  return (
    <div className='flex flex-col-reverse md:flex md:flex-row mb-20 justify_between'>
        <div className='flex w-full md:w-8/12 flex-col'>
                ...
                <h1 className={`text-center md:text-left text-2xl md:text-4xl lg:text-6xl tracking-wide font-bold leading-tight text-main`}>Empowering brands with custom, high-converting websites</h1>
